...
func createPatch(target *resource.Info, current runtime.Object, force3WayMergePatch bool) ([]byte, types.PatchType, error) {
	...
	if isUnstructured || isCRD {
		...
		// TODO Helm 4: this `if` for `force3WayMergePatch` should be removed and instead always
		//      use the truthy path.  The flag should be removed from all the commands where it
		//      is accepted: install, upgrade, & rollback.
